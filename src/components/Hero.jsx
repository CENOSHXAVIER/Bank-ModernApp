  ...
  <section id='home' className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    <div className={`flex-1 ${styles.flexStart} flex-col xl:px-0 sm:px-16 px-6`}>
      <div className='flex flex-row items-center py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2'>
        <img src={discount} alt="discount-symbol" className='w-[32px] h-[32px]' />
    ...
    <div >
      <img src={robot} alt="robo-hand-image" className='w-[100%] h-[100%] relative right-0 z-[5]' />
      <div className='absolute z-[0] w-[40%] h-[35%] top-0 pink__gradient'/>
      <div className='absolute z-[0] w-[40%] h-[35%]  white__gradient rounded-full'/>
